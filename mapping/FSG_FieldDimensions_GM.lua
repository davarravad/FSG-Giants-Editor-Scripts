...
-- Name: FSG GM - FieldDimensions with bitmap
...
local filename = "C:/Users/davar/OneDriveEw/Documents/My Games/FarmingSimulator2022/mods/greenMountainMap/FS22_FSG_GM_10/map/data/grleGDM/infoLayer_fieldDimensions.grle";
    ...
    for y = 0, localMapHeight-1 do
        if data.lines[y] ~= nil then
            for _,line in pairs(data.lines[y]) do
                ...
                setTranslation(c2, 0,0,1);
                setTranslation(c3, w, 0,1);
